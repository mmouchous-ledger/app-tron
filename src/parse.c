...
static bool freeze_balance_v2_contract(txContent_t *content,
                                    pb_istream_t *stream) {
  if (!pb_decode(stream, protocol_FreezeBalanceV2Contract_fields,
...
static bool unfreeze_balance_v2_contract(txContent_t *content,
                                      pb_istream_t *stream) {
  if (!pb_decode(stream, protocol_UnfreezeBalanceV2Contract_fields,
...
static bool undelegate_resource_contrace(txContent_t *content,
                                      pb_istream_t *stream) {
  if (!pb_decode(stream, protocol_UnDelegateResourceContract_fields,
